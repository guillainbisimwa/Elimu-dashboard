...
export const CommunicationAction = (motif, eleve, id, timestamp) => async (dispatch) => {
  try {
    ...
    dispatch(addCommunicationSuccess({motif, eleve,  id: id=== undefined ? "1235" : id, timestamp: timestamp=== undefined ? "2023-01-01" : timestamp})) // TODO : Just for test!
